<template>
	...
	<footer class="footer-container type_footer1">
						...
						<div class="module clearfix">
							...
							<div class="modcontent">
								<ul class="contact-address">
									<li><span class="fa fa-map-marker"></span> 1 Amed Road Kunwariya. Rajasthan, pin: 313327 India</li>
									<li><span class="fa fa-envelope-o"></span> Email: <a href="#"> luckylelctronic2017@gmail.com</a></li>
									<li><span class="fa fa-phone">&nbsp;</span> Phone 1: +91 8233292863 <br>Phone 2: +91 8233292863</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="footer-bottom-block ">
			<div class=" container">
				<div class="row">
					<div class="col-sm-5 copyright-text"> © 2022 Thorada Services Finance Ltd. All Rights Reserved. </div>
					<div class="col-sm-7">
